            ...
            modules: [
                ...
                },
                {
                    ...
                    files:[
                        ...
                        '../assets/vendors/jquery-datatables/js/jquery.dataTables.js',
                ...
                {
                    name:'CopyServiceModule',
                    files:[
                        'app/modules/shared/services/CopyService.js'
                    ]
                },
                {
                ...
                {
                    name:'OptionlistServiceModule',
                    files:[
                        'app/modules/optionlist/services/OptionlistService.js'
                    ]
                },
                {
                    name:'SupplierProductServiceModule',
                    files:[
                        'app/modules/supplier_product/services/SupplierProductService.js'
                    ]
                },
                {
                    name:'SupplierServiceModule',
                    files:[
                        'app/modules/supplier/services/SupplierService.js'
                    ]
                },
                {
                    name:'ErpCustomerServiceModule',
                    files:[
                        'app/modules/erp_customer/services/ErpCustomerService.js'
                    ]
                },
                {
                    name:'ErpServiceModule',
                    files:[
                        'app/modules/erp/services/ErpService.js'
                    ]
                },
                {
                    name:'StoreServiceModule',
                    files:[
                        'app/modules/store/services/StoreService.js'
                    ]
                },
                {
                    name:'ProjectServiceModule',
                    files:[
                        'app/modules/project/services/ProjectService.js'
                    ]
                },
                {
                    name:'StoreAdministrationServiceModule',
                    files:[
                        'app/modules/store_administration/services/StoreAdministrationService.js'
                    ]
                },
                {
                    name:'StoreLeavingServiceModule',
                    files:[
                        'app/modules/store_leaving/services/StoreLeavingService.js'
                    ]
                },
                {
                    name:'GasStationsServiceModule',
                    files:[
                        'app/modules/gas_stations/services/GasStationsService.js'
                    ]
                },
                {
                    name:'StoreReviewServiceModule',
                    files:[
                        'app/modules/store_review/services/StoreReviewService.js'
                    ]
                },
                {
                    name:'SupplierCheckServiceModule',
                    files:[
                        'app/modules/supplier_check/services/SupplierCheckService.js'
                    ]
                },
                {
                    name:'RegistrationsServiceModule',
                    files:[
                        'app/modules/registrations/services/RegistrationsService.js'
                    ]
                },
                {
                    name:'ForwardRequestServiceModule',
                    files:[
                        'app/shared/services/ForwardRequestService.js'
                    ]
                },
                {
                    name:'AngularjsDropdownMultiselectModule',
                    files:[
                        '../assets/vendors/dotansimha-angularjs-dropdown-multiselect-e73fca5/angularjs-dropdown-multiselect.min.js'
                    ]
                },
                {
                    name:'LodashModule',
                    files:[
                        '../assets/vendors/node_modules/lodash/lodash.min.js'
                    ]
                },
                /****************************************************************
