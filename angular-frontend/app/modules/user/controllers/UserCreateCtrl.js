...
app.controller('UserCreateCtrl',function($scope,UserService,RoleService,OptionlistService,$http,$rootScope,resolvedItems,$translatePartialLoader,trans,Notification){
