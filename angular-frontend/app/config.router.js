...
app
    .run(function($rootScope, $state,$stateParams,$translate,tmhDynamicLocale,Restangular,$filter) {
        // add listener for change page title and parent menu activation
        $rootScope.$state = $state;
        $rootScope.$stateParams = $stateParams;

        $rootScope.programm_version = "v0.1";

        // Wartungsfenster Ankuendigung(5 Tage davor) und Abschaltung (im Wartungsfenster)
        var wartungsfenster_von = '2020.11.14 14:00';
        var wartungsfenster_bis = '2020.11.15 18:00';
        //
        $rootScope.today = $filter('date')(new Date(), 'yyyy.MM.dd HH:mm');
        $rootScope.wartungsfenster_von = $filter('date')(Date.parse(wartungsfenster_von), 'yyyy.MM.dd HH:mm');
        $rootScope.wartungsfenster_bis = $filter('date')(Date.parse(wartungsfenster_bis), 'yyyy.MM.dd HH:mm');
        var days = 86400000;
        var d = Date.parse(wartungsfenster_von);
        $rootScope.warnung_von = $filter('date')(new Date(d - (5*days)), 'yyyy.MM.dd HH:mm' );


        //dynamic load angularjs locale
        $rootScope.currentLanguage = 'de-de';
    ...
    .config(function($stateProvider,$urlRouterProvider,$locationProvider,$breadcrumbProvider,$authProvider,RestangularProvider,CacheFactoryProvider,$translateProvider,tmhDynamicLocaleProvider,NotificationProvider,$translatePartialLoaderProvider) {
        ...
        $translateProvider
            ...
            .registerAvailableLanguageKeys(['de-de'], { // register your language key and browser key find
                '*': 'de-de'
            })
         ...
         * Restangular API URL
         */
        RestangularProvider.setBaseUrl('../backend/public/api');
         ...
         *  ngAA Config
         */
        $authProvider.signinUrl = '../backend/public/api/authenticate';
        ...
        $stateProvider
            ...
            .state('change-password', {
                url: '/password/change',
                templateUrl: 'app/shared/views/changePassword.html',
                controller:'ChangePassCtrl',
                resolve: {
                    dep: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                            return $ocLazyLoad.load(['sweet-alert','app/shared/controllers/ChangePassCtrl.js']);
                        }]
                }
            })
            .state('admin', {
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['ui-bs-paging', 'ForwardRequestServiceModule']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/shared/controllers/AdminCtrl.js','app/modules/user/views/userform.html']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.createUser',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['dropzone','RoleServiceModule','UserServiceModule','OptionlistServiceModule']).then(
                                function(){
            ...
            .state('admin.editUser',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['dropzone','RoleServiceModule','UserServiceModule','OptionlistServiceModule','ui-select-filter','select2']).then(
                                function(){
            ...
            .state('admin.optionlists',{
                url: "/optionlists",
                templateUrl: "app/modules/optionlist/views/optionlists.html",
                ncyBreadcrumb: {
                    label: 'app.breadcrumb.optionlists',// angular translate variable
                    parent:'admin'
                },
                data: {
                    permits: {
                        withAny: ['view_optionlist','delete_optionlist','add_optionlist','edit_optionlist']
                    }
                },
                ...
                resolve: {
                    trans:['RequireTranslations',
                        function (RequireTranslations) {
                            RequireTranslations('modules/optionlist');
                        }],
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','OptionlistServiceModule']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/optionlist/controllers/OptionlistCtrl.js']);
                                }
                            );
                        }],
                    resolvedItems:['dep','OptionlistService',
                        function(dep,OptionlistService) {
                            return OptionlistService.cachedList().then(function(data){
                                return data;
                            });
                        }]
                }
...
///////////////////////////////////////////// Benutzerstati //////////////////////////////////////////////////////////////
            .state('admin.registrations',{
                url: "/registrations",
                templateUrl: "app/modules/registrations/views/registrations.html",
                data: {
                    permits: {
                        withAny: ['view_registrations','delete_registrations','add_registrations','edit_registrations']
                    }
                },
                ...
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','RegistrationsServiceModule','ui-select-filter','panel-flat','summernote','jasny-bootstrap','ui-select-filter','select2','bootstrap-datepicker','bootstrap-timepicker','sweet-alert']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/registrations/controllers/RegistrationsCtrl.js']);
                                }
                            );
                        }]
                }
            })
            .state('admin.registration_delete',{
                url: "/registration_delete",
                templateUrl: "app/modules/registrations/views/registration_delete.html",
                data: {
                    permits: {
                        withAny: ['delete_registrations']
                    }
                },
                controller:'RegistrationsCtrl',
                resolve: {
            ...
            .state('admin.store_leaving',{
                url: "/store_leaving",
                templateUrl: "app/modules/store_leaving/views/store_leaving.html",
                data: {
                    permits: {
                        withAny: ['view_store_leaving','delete_store_leaving','add_store_leaving','edit_store_leaving']
                    }
                },
                controller:'StoreLeavingCtrl',
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','StoreLeavingServiceModule','SupplierProductServiceModule','panel-flat','summernote','jasny-bootstrap','select2','momentjs','jquery-ui','bootstrap-datepicker','bootstrap-timepicker','datatable']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/store_leaving/controllers/StoreLeavingCtrl.js']);
                                }
                            );
                        }]
                }
            })
            .state('admin.store_review',{
                url: "/store_review",
                templateUrl: "app/modules/store_review/views/store_review.html",
                data: {
                    permits: {
                        withAny: ['view_store_review','delete_store_review','add_store_review','edit_store_review']
                    }
                },
                ...
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','StoreReviewServiceModule','SupplierProductServiceModule','SupplierServiceModule','ui-select-filter','panel-flat','summernote','jasny-bootstrap','ui-select-filter','select2','momentjs','bootstrap-datepicker','bootstrap-timepicker','sweet-alert']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/store_review/controllers/StoreReviewCtrl.js']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.gas_stations',{
                url: "/gas_stations",
                templateUrl: "app/modules/gas_stations/views/gas_stations.html",
                data: {
                    permits: {
                        withAny: ['view_gas_stations','delete_gas_stations','add_gas_stations','edit_gas_stations']
                    }
                },
                ...
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','datatable','GasStationsServiceModule','SupplierProductServiceModule','SupplierServiceModule','CopyServiceModule','panel-flat','jasny-bootstrap','ui-select-filter','select2','momentjs','jquery-ui','bootstrap-datepicker','bootstrap-timepicker']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/gas_stations/controllers/GasStationsCtrl.js']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.supplier_check',{
                url: "/supplier_check",
                templateUrl: "app/modules/supplier_check/views/supplier_check.html",
                data: {
                    permits: {
                        withAny: ['edit_supplier_check']
                    }
                },
                controller:'SupplierCheckCtrl',
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','SupplierCheckServiceModule','SupplierProductServiceModule','CopyServiceModule','OptionlistServiceModule','ui-select-filter','jquery-ui','panel-flat','summernote','jasny-bootstrap','select2','momentjs','bootstrap-datepicker','bootstrap-timepicker','sweet-alert','datatable']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/supplier_check/controllers/SupplierCheckCtrl.js']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.supplier_check_view',{
                url: "/supplier_check_review",
                templateUrl: "app/modules/supplier_check/views/supplier_check_review.html",
                data: {
                    permits: {
                        withAny: ['view_supplier_check','edit_supplier_check']
                    }
                },
                controller:'SupplierCheckCtrl',
                resolve: {
            ...
            .state('admin.artikel_umbuchungen_edit',{
                url: "/artikel_umbuchungen_edit",
                templateUrl: "app/modules/artikel_umbuchungen/views/artikel_umbuchungen_edit.html",
                data: {
                    permits: {
                        withAny: ['edit_artikel_umbuchungen']
                    }
                },
                controller:'ArtikelUmbuchungenEditCtrl',
                controllerAs: "myArtUmbuchCtrl",
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','ui-select-filter','jquery-ui','panel-flat','summernote','jasny-bootstrap','select2','momentjs','bootstrap-datepicker','bootstrap-timepicker','sweet-alert','datatable','ArtikelUmbuchungenServiceModule','AngularjsDropdownMultiselectModule','LodashModule']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/artikel_umbuchungen/controllers/ArtikelUmbuchungenEditCtrl.js']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.artikel_umbuchungen_view',{
                url: "/artikel_umbuchungen_view",
                templateUrl: "app/modules/artikel_umbuchungen/views/artikel_umbuchungen_view.html",
                data: {
                    permits: {
                        withAny: ['view_artikel_umbuchungen','edit_artikel_umbuchungen']
                    }
                },
                controller:'ArtikelUmbuchungenViewCtrl',
                controllerAs: "myArtUmbuchCtrl",
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','ui-select-filter','jquery-ui','panel-flat','summernote','jasny-bootstrap','select2','momentjs','bootstrap-datepicker','bootstrap-timepicker','sweet-alert','datatable','ArtikelUmbuchungenServiceModule']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/artikel_umbuchungen/controllers/ArtikelUmbuchungenViewCtrl.js']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.bestellungen',{
                url: "/bestellungen",
                templateUrl: "app/modules/bestellungen/views/bestellungen.html",
                data: {
                    permits: {
                        withAny: ['view_bestellungen','edit_bestellungen']
                    }
                },
                ...
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','ui-select-filter','jquery-ui','panel-flat','summernote','jasny-bootstrap','select2','momentjs','bootstrap-datepicker','bootstrap-timepicker','datatable','ForwardRequestServiceModule']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/bestellungen/controllers/BestellungenCtrl.js']);
                                }
                            );
                        }]
                }
            ...
            .state('admin.flaschentaxi',{
                url: "/flaschentaxi",
                templateUrl: "app/modules/flaschentaxi/views/flaschentaxi.html",
                data: {
                    permits: {
                        withAny: ['view_flaschentaxi']
                    }
                },
                controller:'FlaschentaxiCtrl',
                resolve: {
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert','ui-select-filter','jquery-ui','panel-flat','summernote','jasny-bootstrap','select2','momentjs','bootstrap-datepicker','bootstrap-timepicker','ForwardRequestServiceModule']).then(
                                function(){
                                    return $ocLazyLoad.load(['app/modules/flaschentaxi/controllers/FlaschentaxiCtrl.js']);
                                }
                            );
                        }]
                }
